package com.example.nfc_ndef_android_emulation_example.cardEmulation
...
//    private var NDEF_URI = NdefMessage(createTextRecord("en", "Ciao, come va?", NDEF_ID))
    private var NDEF_URI = NdefMessage(createTextRecord("en", "buenas tardes", NDEF_ID))
    ...
    fun DatosPrueba():String {
        return "{\"codigo\":\"29032021\",\"ambiente\":\"ASAMBLEA\",\"usuario\":\"juan\"}"
    }
...
//        NDEF_URI = NdefMessage(createTextRecord("en", getDeviceUniqueID(), NDEF_ID))
//        NDEF_URI = NdefMessage(createTextRecord("en", DatosPrueba(), NDEF_ID))
//         NDEF_URI_BYTES = NDEF_URI.toByteArray()
//        NDEF_URI_LEN = fillByteArrayToFixedDimension(
//            BigInteger.valueOf(NDEF_URI_BYTES.size.toLong()).toByteArray(), 2
//        )
